...
(function (root, factory) {
  ...
  function createManualCleanupConfig() {
    return {
      ...
      // Для мелкой фактуры (дерево/ткань/трава) MI-GAN на 2048 часто рисует заметные
      // волокна. В таких зонах модель думает в 1024, но результат скачивается в исходном
      // разрешении.
      miganTextureFallbackLongSide: 1024,
      miganTextureFallbackMinEdge: 7,
